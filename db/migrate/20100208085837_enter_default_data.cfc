<cfcomponent extends="plugins.dbmigrate.Migration" hint="enter default data">
  <cffunction name="up">
    ...
    addRecord(table="pages", title="Home", slug="/", breadcrumb="Home", pageclassid="1", status="Published", parentid="0", layoutid="1", description="Base Home Page", createdbyid="1");
    addRecord(table="pages", title="File Not Found", slug="/file-not-found", breadcrumb="File Not Found", pageclassid="2", status="Published", parentid="1", layoutid="1", description="File Not Found", createdbyid="1");
